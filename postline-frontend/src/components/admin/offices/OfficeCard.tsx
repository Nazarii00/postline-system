...
const OfficeCard = ({ department, onDetails, onDelete }: Props) => (
  <article
  ...
  >
    ...
    <div className="flex gap-2 mt-auto">
      <button
        ...
        className="flex-1 py-3 bg-slate-100 text-slate-700 rounded-2xl text-sm font-bold flex items-center justify-center gap-2 hover:bg-pine hover:text-white transition-colors"
      >
