        ...
        <header className="h-20 shrink-0 bg-white/80 backdrop-blur-md border-b border-slate-200 px-4 md:px-8 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div className="hidden md:flex items-center gap-2 text-xs font-bold text-slate-400 uppercase tracking-widest">
              Відділення №1 <span className="text-slate-300">/</span> <span className="text-pine">Львів, вул. Городоцька, 15</span>
            </div>
          </div>

          <div className="flex items-center gap-4">
            <div className="text-right hidden sm:block">
              <p className="text-sm font-bold text-slate-900 leading-none">Боднар Назарій</p>
              <p className="text-[10px] text-slate-500 mt-1 uppercase tracking-widest font-bold">Старший оператор</p>
            </div>
            <div className="flex items-center gap-3">
