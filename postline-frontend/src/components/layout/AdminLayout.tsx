          ...
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-3 pl-2">
              <div className="text-right hidden sm:block">
                <p className="text-sm font-bold text-slate-900 leading-none">{user?.fullName ?? 'Адміністратор'}</p>
                <p className="text-[10px] font-medium text-slate-400 mt-1 uppercase">admin</p>
              </div>
